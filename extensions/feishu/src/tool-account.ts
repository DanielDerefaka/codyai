...
import type { CodyAIPluginApi } from "openclaw/plugin-sdk/feishu";
...
function readConfiguredDefaultAccountId(config: CodyAIPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<CodyAIPluginApi, "config">;
