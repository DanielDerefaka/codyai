...
import { createAccountListHelpers, type CodyAIConfig } from "openclaw/plugin-sdk/zalouser";
...
function mergeZalouserAccountConfig(cfg: CodyAIConfig, accountId: string): ZalouserAccountConfig {
