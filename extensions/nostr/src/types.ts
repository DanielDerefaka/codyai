...
import type { CodyAIConfig } from "openclaw/plugin-sdk/nostr";
...
function resolveConfiguredDefaultNostrAccountId(cfg: CodyAIConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: CodyAIConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: CodyAIConfig): string {
