...
import type { CodyAIPluginServiceContext } from "openclaw/plugin-sdk/diagnostics-otel";
...
function createTraceOnlyContext(endpoint: string): CodyAIPluginServiceContext {
