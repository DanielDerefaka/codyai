...
describe("loginGeminiCliOAuth", () => {
  ...
  const ENV_KEYS = [
    "CODYAI_GEMINI_OAUTH_CLIENT_ID",
    "CODYAI_GEMINI_OAUTH_CLIENT_SECRET",
  ...
  beforeEach(() => {
    ...
    process.env.CODYAI_GEMINI_OAUTH_CLIENT_ID = "test-client-id.apps.googleusercontent.com";
    process.env.CODYAI_GEMINI_OAUTH_CLIENT_SECRET = "GOCSPX-test-client-secret"; // pragma: allowlist secret
