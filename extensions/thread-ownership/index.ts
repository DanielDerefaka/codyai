import type { CodyAIConfig, CodyAIPluginApi } from "openclaw/plugin-sdk/thread-ownership";
...
function resolveOwnershipAgent(config: CodyAIConfig): { id: string; name: string } {
