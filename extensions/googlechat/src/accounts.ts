...
import { createAccountListHelpers, type CodyAIConfig } from "openclaw/plugin-sdk/googlechat";
...
export function listEnabledGoogleChatAccounts(cfg: CodyAIConfig): ResolvedGoogleChatAccount[] {
