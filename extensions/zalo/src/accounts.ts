...
import { createAccountListHelpers, type CodyAIConfig } from "openclaw/plugin-sdk/zalo";
...
function mergeZaloAccountConfig(cfg: CodyAIConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: CodyAIConfig): ResolvedZaloAccount[] {
