...
import { resolveChannelMediaMaxBytes, type CodyAIConfig } from "openclaw/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: CodyAIConfig; accountId?: string }): string[] {
