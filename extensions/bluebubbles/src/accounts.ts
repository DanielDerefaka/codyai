...
import { createAccountListHelpers, type CodyAIConfig } from "openclaw/plugin-sdk/bluebubbles";
...
export function listEnabledBlueBubblesAccounts(cfg: CodyAIConfig): ResolvedBlueBubblesAccount[] {
