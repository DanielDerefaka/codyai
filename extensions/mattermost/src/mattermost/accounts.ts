...
import { createAccountListHelpers, type CodyAIConfig } from "openclaw/plugin-sdk/mattermost";
...
export function listEnabledMattermostAccounts(cfg: CodyAIConfig): ResolvedMattermostAccount[] {
