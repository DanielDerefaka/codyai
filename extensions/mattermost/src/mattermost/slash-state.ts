...
import type { CodyAIPluginApi } from "openclaw/plugin-sdk/mattermost";
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("openclaw/plugin-sdk/mattermost").CodyAIConfig;
 ...
 */
export function registerSlashCommandRoute(api: CodyAIPluginApi) {
