...
if [[ -n "${CODYAI_IOS_BUNDLE_SUFFIX:-}" ]]; then
  identity_source="${CODYAI_IOS_BUNDLE_SUFFIX}"
else
...
bundle_base="${CODYAI_IOS_APP_BUNDLE_ID:-${CODYAI_IOS_BUNDLE_ID_BASE:-}}"
if [[ -z "${bundle_base}" ]]; then
  bundle_base="ai.openclaw.ios.test.${bundle_suffix}"
fi
bundle_base="$(normalize_bundle_id "${bundle_base}")"

share_bundle_id="${CODYAI_IOS_SHARE_BUNDLE_ID:-${bundle_base}.share}"
activity_widget_bundle_id="${CODYAI_IOS_ACTIVITY_WIDGET_BUNDLE_ID:-${bundle_base}.activitywidget}"
watch_app_bundle_id="${CODYAI_IOS_WATCH_APP_BUNDLE_ID:-${bundle_base}.watchkitapp}"
watch_extension_bundle_id="${CODYAI_IOS_WATCH_EXTENSION_BUNDLE_ID:-${watch_app_bundle_id}.extension}"

code_sign_style="${CODYAI_IOS_CODE_SIGN_STYLE:-Automatic}"
app_profile="${CODYAI_IOS_APP_PROFILE:-}"
share_profile="${CODYAI_IOS_SHARE_PROFILE:-}"
...
// CODYAI_IOS_APP_BUNDLE_ID / CODYAI_IOS_BUNDLE_ID_BASE
// CODYAI_IOS_SHARE_BUNDLE_ID / CODYAI_IOS_ACTIVITY_WIDGET_BUNDLE_ID
// CODYAI_IOS_WATCH_APP_BUNDLE_ID / CODYAI_IOS_WATCH_EXTENSION_BUNDLE_ID
// CODYAI_IOS_CODE_SIGN_STYLE / CODYAI_IOS_APP_PROFILE / CODYAI_IOS_SHARE_PROFILE
CODYAI_CODE_SIGN_STYLE = ${code_sign_style}
CODYAI_DEVELOPMENT_TEAM = ${team_id}
// Keep legacy key for compatibility with older signing config paths.
CODYAI_IOS_SELECTED_TEAM = ${team_id}
CODYAI_APP_BUNDLE_ID = ${bundle_base}
CODYAI_SHARE_BUNDLE_ID = ${share_bundle_id}
CODYAI_ACTIVITY_WIDGET_BUNDLE_ID = ${activity_widget_bundle_id}
CODYAI_WATCH_APP_BUNDLE_ID = ${watch_app_bundle_id}
CODYAI_WATCH_EXTENSION_BUNDLE_ID = ${watch_extension_bundle_id}
CODYAI_APP_PROFILE = ${app_profile}
CODYAI_SHARE_PROFILE = ${share_profile}
EOF
