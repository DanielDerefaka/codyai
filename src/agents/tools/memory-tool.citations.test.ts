...
function asCodyAIConfig(config: Partial<CodyAIConfig>): CodyAIConfig {
  return config as CodyAIConfig;
}

function createToolConfig() {
  return asCodyAIConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: CodyAIConfig = createToolConfig()) {
