...
function resolveMemoryToolContext(options: { config?: CodyAIConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: CodyAIConfig): MemoryCitationsMode {
