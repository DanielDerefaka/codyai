...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): CodyAIConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: CodyAIConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: CodyAIConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
