...
const FAST_TEST_MODE = process.env.CODYAI_TEST_FAST === "1";
    ...
    lines.push(
      ...
      ...(acpEnabled
        ? [
            ...
            '`agents_list` and `subagents` apply to CodyAI sub-agents (`runtime: "subagent"`); ACP harness ids are controlled by `acp.allowedAgents`.',
            ...
            'Use `subagents` only for CodyAI subagents (`runtime: "subagent"`).',
