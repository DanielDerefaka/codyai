...
function makeFallbacksOnlyCfg(): CodyAIConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeProviderFallbackCfg(provider: string): CodyAIConfig {
  return makeCfg({
    agents: {
      defaults: {
        model: {
...
// Internal CodyAI compatibility marker, not a provider API contract.
