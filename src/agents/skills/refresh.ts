...
function resolveWatchPaths(workspaceDir: string, config?: CodyAIConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: CodyAIConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: CodyAIConfig }) {
