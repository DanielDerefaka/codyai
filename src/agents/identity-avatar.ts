...
function resolveAvatarSource(cfg: CodyAIConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: CodyAIConfig, agentId: string): AgentAvatarResolution {
