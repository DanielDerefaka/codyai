...
async function resolveContext(config: CodyAIConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): CodyAIConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
