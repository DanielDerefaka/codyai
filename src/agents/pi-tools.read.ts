...
function resolveAdaptiveReadMaxBytes(options?: CodyAIReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createCodyAIReadTool(base, {
...
export function createCodyAIReadTool(
  base: AnyAgentTool,
  options?: CodyAIReadToolOptions,
): AnyAgentTool {
