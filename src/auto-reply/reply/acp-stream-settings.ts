...
function resolveAcpStreamCoalesceIdleMs(cfg: CodyAIConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: CodyAIConfig): number {
...
export function resolveAcpProjectionSettings(cfg: CodyAIConfig): AcpProjectionSettings {
