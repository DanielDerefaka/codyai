...
function resolveMentionPatterns(cfg: CodyAIConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: CodyAIConfig | undefined, agentId?: string): RegExp[] {
