...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.CODYAI_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.CODYAI_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.CODYAI_SERVICE_MARKER = originalServiceMarker;
    }
  });
