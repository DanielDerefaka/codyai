...
export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "CODYAI_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "CODYAI_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "CODYAI_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable CODYAI_TELEGRAM_DNS_RESULT_ORDER
