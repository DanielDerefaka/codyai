...
describe("browser control evaluate gating", () => {
  beforeEach(async () => {
    ...
    prevGatewayPort = process.env.CODYAI_GATEWAY_PORT;
    process.env.CODYAI_GATEWAY_PORT = String(testPort - 2);
    prevGatewayToken = process.env.CODYAI_GATEWAY_TOKEN;
    prevGatewayPassword = process.env.CODYAI_GATEWAY_PASSWORD;
