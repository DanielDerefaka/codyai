 ...
 */
export function decorateCodyAIProfile(
  userDataDir: string,
  opts?: { name?: string; color?: string },
) {
  const desiredName = opts?.name ?? DEFAULT_CODYAI_BROWSER_PROFILE_NAME;
  const desiredColor = (opts?.color ?? DEFAULT_CODYAI_BROWSER_COLOR).toUpperCase();
