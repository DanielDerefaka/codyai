...
function resolveResolutionLimits(config: CodyAIConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: CodyAIConfig): SecretProviderConfig {
