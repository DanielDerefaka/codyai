...
export function listAuthProfileStorePaths(config: CodyAIConfig, stateDir: string): string[] {
...
export function listAgentModelsJsonPaths(config: CodyAIConfig, stateDir: string): string[] {
