...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof CodyAIConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: CodyAIConfig; env: NodeJS.ProcessEnv }): {
  cfg: CodyAIConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
