...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.CODYAI_TTS_PREFS;
      process.env.CODYAI_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.CODYAI_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: CodyAIConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
