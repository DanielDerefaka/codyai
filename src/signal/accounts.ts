...
function mergeSignalAccountConfig(cfg: CodyAIConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: CodyAIConfig): ResolvedSignalAccount[] {
