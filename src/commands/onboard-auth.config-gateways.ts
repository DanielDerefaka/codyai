...
export function applyVercelAiGatewayProviderConfig(cfg: CodyAIConfig): CodyAIConfig {
...
export function applyVercelAiGatewayConfig(cfg: CodyAIConfig): CodyAIConfig {
