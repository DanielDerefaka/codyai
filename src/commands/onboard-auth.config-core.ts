...
export function applyOpenrouterProviderConfig(cfg: CodyAIConfig): CodyAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: CodyAIConfig): CodyAIConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: CodyAIConfig): CodyAIConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: CodyAIConfig): CodyAIConfig {
...
export function applyMoonshotConfig(cfg: CodyAIConfig): CodyAIConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: CodyAIConfig): CodyAIConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: CodyAIConfig): CodyAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: CodyAIConfig): CodyAIConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: CodyAIConfig): CodyAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: CodyAIConfig): CodyAIConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: CodyAIConfig): CodyAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: CodyAIConfig): CodyAIConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: CodyAIConfig): CodyAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: CodyAIConfig): CodyAIConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: CodyAIConfig): CodyAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: CodyAIConfig): CodyAIConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: CodyAIConfig): CodyAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: CodyAIConfig): CodyAIConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: CodyAIConfig): CodyAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: CodyAIConfig): CodyAIConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: CodyAIConfig): CodyAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: CodyAIConfig): CodyAIConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: CodyAIConfig): CodyAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: CodyAIConfig): CodyAIConfig {
...
export function applyQianfanProviderConfig(cfg: CodyAIConfig): CodyAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: CodyAIConfig): CodyAIConfig {
