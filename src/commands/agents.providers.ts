...
function resolveDefaultAccountId(cfg: CodyAIConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: CodyAIConfig): boolean {
...
export function summarizeBindings(cfg: CodyAIConfig, bindings: AgentBinding[]): string[] {
