...
import type { CodyAIConfig, GatewayBindMode } from "../config/config.js";
...
function collectImplicitHeartbeatDirectPolicyWarnings(cfg: CodyAIConfig): string[] {
...
export async function noteSecurityWarnings(cfg: CodyAIConfig) {
  const warnings: string[] = [];
