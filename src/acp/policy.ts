...
export function isAcpEnabledByPolicy(cfg: CodyAIConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: CodyAIConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: CodyAIConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: CodyAIConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: CodyAIConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: CodyAIConfig, agentId: string): boolean {
