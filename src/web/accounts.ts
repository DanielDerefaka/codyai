...
export function listWhatsAppAuthDirs(cfg: CodyAIConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: CodyAIConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: CodyAIConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: CodyAIConfig): ResolvedWhatsAppAccount[] {
