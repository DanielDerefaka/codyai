...
export type CodyAIPluginConfigSchema = {
...
export type CodyAIPluginToolContext = {
  config?: CodyAIConfig;
  workspaceDir?: string;
  agentDir?: string;
  agentId?: string;
...
export type CodyAIPluginToolFactory = (
  ctx: CodyAIPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type CodyAIPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type CodyAIPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<CodyAIConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type CodyAIPluginGatewayMethod = {
  method: string;
 ...
 */
export type CodyAIPluginCommandDefinition = {
...
export type CodyAIPluginHttpRouteAuth = "gateway" | "plugin";
export type CodyAIPluginHttpRouteMatch = "exact" | "prefix";

export type CodyAIPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean | void> | boolean | void;

export type CodyAIPluginHttpRouteParams = {
  path: string;
  handler: CodyAIPluginHttpRouteHandler;
  auth: CodyAIPluginHttpRouteAuth;
  match?: CodyAIPluginHttpRouteMatch;
  replaceExisting?: boolean;
};

export type CodyAIPluginCliContext = {
  program: Command;
  config: CodyAIConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type CodyAIPluginCliRegistrar = (ctx: CodyAIPluginCliContext) => void | Promise<void>;

export type CodyAIPluginServiceContext = {
  config: CodyAIConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type CodyAIPluginService = {
  id: string;
  start: (ctx: CodyAIPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: CodyAIPluginServiceContext) => void | Promise<void>;
};

export type CodyAIPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type CodyAIPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: CodyAIPluginConfigSchema;
  register?: (api: CodyAIPluginApi) => void | Promise<void>;
  activate?: (api: CodyAIPluginApi) => void | Promise<void>;
};

export type CodyAIPluginModule =
  | CodyAIPluginDefinition
  | ((api: CodyAIPluginApi) => void | Promise<void>);

export type CodyAIPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | CodyAIPluginToolFactory,
    opts?: CodyAIPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: CodyAIPluginHookOptions,
  ) => void;
  registerHttpRoute: (params: CodyAIPluginHttpRouteParams) => void;
  registerChannel: (registration: CodyAIPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: CodyAIPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: CodyAIPluginService) => void;
   ...
   */
  registerCommand: (command: CodyAIPluginCommandDefinition) => void;
