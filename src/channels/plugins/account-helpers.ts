...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: CodyAIConfig): string | undefined {
  ...
  function listAccountIds(cfg: CodyAIConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: CodyAIConfig): string {
