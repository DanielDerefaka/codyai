...
export type ChannelAgentToolFactory = (params: { cfg?: CodyAIConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: CodyAIConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
   ...
   */
  listActions?: (params: { cfg: CodyAIConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: CodyAIConfig }) => boolean;
  supportsCards?: (params: { cfg: CodyAIConfig }) => boolean;
