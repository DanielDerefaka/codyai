...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: CodyAIConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: CodyAIConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: CodyAIConfig) => string;
  setAccountEnabled?: (params: {
    cfg: CodyAIConfig;
    accountId: string;
    enabled: boolean;
  }) => CodyAIConfig;
  deleteAccount?: (params: { cfg: CodyAIConfig; accountId: string }) => CodyAIConfig;
  isEnabled?: (account: ResolvedAccount, cfg: CodyAIConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: CodyAIConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: CodyAIConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: CodyAIConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: CodyAIConfig) => ChannelAccountSnapshot;
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: CodyAIConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
