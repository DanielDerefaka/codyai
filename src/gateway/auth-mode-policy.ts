...
export function hasAmbiguousGatewayAuthModeConfig(cfg: CodyAIConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: CodyAIConfig): void {
