...
export function resolveHooksConfig(cfg: CodyAIConfig): HooksConfigResolved | null {
...
function resolveKnownAgentIds(cfg: CodyAIConfig, defaultAgentId: string): Set<string> {
