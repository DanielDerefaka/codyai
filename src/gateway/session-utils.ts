...
import { type CodyAIConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: CodyAIConfig): string[] {
...
export function listAgentsForGateway(cfg: CodyAIConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: CodyAIConfig): string {
...
function resolveSessionStoreAgentId(cfg: CodyAIConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: CodyAIConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: CodyAIConfig): GatewaySessionsDefaults {
