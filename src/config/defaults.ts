...
function resolveAnthropicDefaultAuthMode(cfg: CodyAIConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: CodyAIConfig): CodyAIConfig {
...
export function applyTalkApiKey(config: CodyAIConfig): CodyAIConfig {
...
export function applyTalkConfigNormalization(config: CodyAIConfig): CodyAIConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: CodyAIConfig): CodyAIConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: CodyAIConfig): CodyAIConfig {
...
export function applyLoggingDefaults(cfg: CodyAIConfig): CodyAIConfig {
...
export function applyContextPruningDefaults(cfg: CodyAIConfig): CodyAIConfig {
...
export function applyCompactionDefaults(cfg: CodyAIConfig): CodyAIConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
