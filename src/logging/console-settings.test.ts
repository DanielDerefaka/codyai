...
let originalCodyAITestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalCodyAITestConsole = process.env.CODYAI_TEST_CONSOLE;
  process.env.CODYAI_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalCodyAITestConsole === undefined) {
    delete process.env.CODYAI_TEST_CONSOLE;
  } else {
    process.env.CODYAI_TEST_CONSOLE = originalCodyAITestConsole;
  }
