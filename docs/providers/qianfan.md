---
summary: "Use Qianfan's unified API to access many models in CodyAI"
read_when:
...
3. CodyAI installed on your system
...
4. Copy the API key for use with CodyAI

## CLI setup

```bash
codyai onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [CodyAI Configuration](/gateway/configuration)
