---
summary: "Use Synthetic's Anthropic-compatible API in CodyAI"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. CodyAI registers it as the
...
Note: CodyAI's Anthropic client appends `/v1` to the base URL, so use
