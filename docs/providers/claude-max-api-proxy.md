...
You can point CodyAI at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or CodyAI
...
- [Anthropic provider](/providers/anthropic) - Native CodyAI integration with Claude setup-token or API keys
