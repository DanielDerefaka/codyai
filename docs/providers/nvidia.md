---
summary: "Use NVIDIA's OpenAI-compatible API in CodyAI"
read_when:
  - You want to use NVIDIA models in CodyAI
...
codyai onboard --auth-choice skip
codyai models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
