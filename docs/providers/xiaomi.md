---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with CodyAI"
read_when:
  - You want Xiaomi MiMo models in CodyAI
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). CodyAI uses
