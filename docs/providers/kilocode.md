---
summary: "Use Kilo Gateway's unified API to access many models in CodyAI"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in CodyAI
---
...
```bash
codyai onboard --kilocode-api-key <key>
```
...
CodyAI dynamically discovers available models from the Kilo Gateway at startup. Use
