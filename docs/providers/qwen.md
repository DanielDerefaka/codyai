---
summary: "Use Qwen OAuth (free tier) in CodyAI"
read_when:
  - You want to use Qwen with CodyAI
...
If you already logged in with the Qwen Code CLI, CodyAI will sync credentials
