...
codyai system heartbeat last
codyai logs --follow
codyai config get agents.defaults.heartbeat
codyai channels status --probe
```
...
```bash
codyai config get agents.defaults.heartbeat.activeHours
codyai config get agents.defaults.heartbeat.activeHours.timezone
codyai config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
codyai cron list
codyai logs --follow
```
