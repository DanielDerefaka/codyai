...
read_when:
  - You are building a CodyAI plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (codyai.plugin.json)

Every plugin **must** ship a `codyai.plugin.json` file in the **plugin root**.
CodyAI uses this manifest to validate configuration **without executing plugin
