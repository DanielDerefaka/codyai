...
- Install via CLI: `codyai plugins install @codyai/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `codyai plugins install ./extensions/zalo`
   - From npm (if published): `codyai plugins install @codyai/zalo`
...
- Approve via:
  - `codyai pairing list zalo`
  - `codyai pairing approve zalo <CODE>`
...
- Example: `codyai message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `codyai channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `codyai logs --follow`
