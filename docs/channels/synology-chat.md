---
summary: "Synology Chat webhook setup and CodyAI config"
read_when:
  - Setting up Synology Chat with CodyAI
...
```bash
codyai plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your CodyAI gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in CodyAI.
...
- Pairing approvals work with:
  - `codyai pairing list synology-chat`
  - `codyai pairing approve synology-chat <CODE>`
...
```bash
codyai message send --channel synology-chat --target 123456 --text "Hello from CodyAI"
codyai message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
