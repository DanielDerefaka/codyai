...
CodyAI treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams, Zalo.

## Beginner intro (2 minutes)

CodyAI “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, CodyAI can see that group and respond there.
...
Translation: allowlisted senders can trigger CodyAI by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@codyai", "codyai", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
