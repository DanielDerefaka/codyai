...
本指南总结了在 CodyAI 中开发 Pi 集成的合理工作流程。
...
状态存储在 CodyAI 状态目录下。默认为 `~/.codyai`。如果设置了 `CODYAI_STATE_DIR`，则使用该目录。
...
- https://docs.codyai.ai/testing
- https://docs.codyai.ai/start/getting-started
