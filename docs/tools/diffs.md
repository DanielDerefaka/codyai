...
Set plugin-wide defaults in `~/.codyai/codyai.json`:
...
- Artifacts are stored under the temp subfolder: `$TMPDIR/codyai-diffs`.
...
1. `browser.executablePath` in CodyAI config.
2. Environment variables:
   - `CODYAI_BROWSER_EXECUTABLE_PATH`
