...
CodyAI treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.codyai/settings/voicewake.json`

Shape:

```json
{ "triggers": ["codyai", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
