...
CodyAI ships three update channels:
...
When you **explicitly** switch channels with `--channel`, CodyAI also aligns
the install method:
...
When you switch channels with `codyai update`, CodyAI also syncs plugin sources:
