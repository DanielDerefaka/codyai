---
summary: "Overview of CodyAI onboarding options and flows"
read_when:
...
CodyAI supports multiple onboarding paths depending on where the Gateway runs
...
- [`codyai onboard` command](/cli/onboard)

## macOS app onboarding

Use the CodyAI app when you want a fully guided setup on macOS. Docs:
