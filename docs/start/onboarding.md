---
summary: "First-run onboarding flow for CodyAI (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give CodyAI">
...
<Step title="CLI">
  ...
  The app can install the global `codyai` CLI via npm/pnpm so terminal
