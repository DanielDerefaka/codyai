---
summary: "Frequently asked questions about CodyAI setup, configuration, and usage"
read_when:
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up CodyAI?](#whats-the-recommended-way-to-install-and-set-up-codyai)
  ...
  - [I can't access docs.codyai.ai (SSL error). What now?](#i-cant-access-docscodyaiai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or codyai not recognized](#windows-install-says-git-not-found-or-codyai-not-recognized)
  ...
  - [How do I install CodyAI on Linux?](#how-do-i-install-codyai-on-linux)
  - [How do I install CodyAI on a VPS?](#how-do-i-install-codyai-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask CodyAI to update itself?](#can-i-ask-codyai-to-update-itself)
  ...
  - [If I buy a Mac mini to run CodyAI, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-codyai-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different CodyAI instances?](#can-multiple-people-use-one-whatsapp-number-with-different-codyai-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run CodyAI on a dedicated machine?](#how-important-is-it-to-run-codyai-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run CodyAI in a VM and what are the requirements](#can-i-run-codyai-in-a-vm-and-what-are-the-requirements)
- [What is CodyAI?](#what-is-codyai)
  - [What is CodyAI, in one paragraph?](#what-is-codyai-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for CodyAI](#what-are-the-top-five-everyday-use-cases-for-codyai)
  - [Can CodyAI help with lead gen outreach ads and blogs for a SaaS](#can-codyai-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can CodyAI run tasks on a schedule or continuously in the background?](#can-codyai-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with CodyAI saved locally?](#is-all-data-used-with-codyai-saved-locally)
  - [Where does CodyAI store its data?](#where-does-codyai-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall CodyAI?](#how-do-i-completely-uninstall-codyai)
...
- [Config basics](#config-basics)
  ...
  - [Can the CodyAI browser run headless?](#can-the-codyai-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two CodyAI instances talk to each other (local + VPS)?](#can-two-codyai-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does CodyAI load environment variables?](#how-does-codyai-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of CodyAI instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-codyai-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset CodyAI but keep it installed?](#how-do-i-completely-reset-codyai-but-keep-it-installed)
  ...
  - [Why doesn't CodyAI reply in a group?](#why-doesnt-codyai-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do CodyAI, Flawd, and Krill use for models?](#what-do-codyai-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `codyai gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-codyai-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `codyai gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-codyai-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run CodyAI in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-codyai-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart CodyAI?](#i-closed-my-terminal-on-windows-how-do-i-restart-codyai)
  ...
  - [ELI5: `codyai gateway restart` vs `codyai gateway`](#eli5-codyai-gateway-restart-vs-codyai-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose CodyAI to inbound DMs?](#is-it-safe-to-expose-codyai-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/codyai/codyai-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ...
   ```bash
   codyai health --json
   codyai health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://codyai.ai/install.sh | bash -s -- --install-method git
```

This installs CodyAI **from a git checkout**, so the agent can read the code + docs and
...
[https://github.com/codyai/codyai/issues](https://github.com/codyai/codyai/issues)
[https://github.com/codyai/codyai/pulls](https://github.com/codyai/codyai/pulls)

Start with these commands (share outputs when asking for help):

```bash
codyai status
codyai models status
codyai doctor
```

What they do:

- `codyai status`: quick snapshot of gateway/agent health + basic config.
- `codyai models status`: checks provider auth + model availability.
- `codyai doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `codyai status --all`, `codyai logs --follow`,
`codyai gateway status`, `codyai health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up CodyAI

The repo recommends running from source and using the onboarding wizard:

```bash
curl -fsSL https://codyai.ai/install.sh | bash
codyai onboard --install-daemon
```
...
```bash
git clone https://github.com/codyai/codyai.git
cd codyai
pnpm install
pnpm build
...
If you don't have a global install yet, run it via `pnpm codyai onboard`.
...
- If it asks for auth, paste the token from `gateway.auth.token` (or `CODYAI_GATEWAY_TOKEN`) into Control UI settings.
- Retrieve it from the gateway host: `codyai config get gateway.auth.token` (or generate one: `codyai doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `codyai gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy Control UI/WebSocket auth (no token, assumes trusted gateway host); HTTP APIs still require token/password.
- **Tailnet bind**: run `codyai gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
...
1. Install CodyAI on the new machine.
2. Copy `$CODYAI_STATE_DIR` (default: `~/.codyai`) from the old machine.
3. Copy your workspace (default: `~/.codyai/workspace`).
4. Run `codyai doctor` and restart the Gateway service.
...
under `~/.codyai/` (for example `~/.codyai/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-codyai-store-its-data),
...
[https://github.com/codyai/codyai/blob/main/CHANGELOG.md](https://github.com/codyai/codyai/blob/main/CHANGELOG.md)

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I can't access docs.codyai.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.codyai.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.codyai.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docscodyaiai-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: [https://spa.xfinity.com/check_url_status](https://spa.xfinity.com/check_url_status).

If you still can't reach the site, the docs are mirrored on GitHub:
[https://github.com/codyai/codyai/tree/main/docs](https://github.com/codyai/codyai/tree/main/docs)
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://codyai.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://codyai.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
[https://codyai.ai/install.ps1](https://codyai.ai/install.ps1)
...
```bash
curl -fsSL https://codyai.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://codyai.ai/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://codyai.ai/install.sh | bash -s -- --install-method git --verbose
```
...
Set-PSDebug -Trace 1
& ([scriptblock]::Create((iwr -useb https://codyai.ai/install.ps1))) -NoOnboard
Set-PSDebug -Trace 0
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or codyai not recognized
...
**2) codyai is not recognized after install**
...
If you still reproduce this on latest CodyAI, track/report it in:

- [Issue #30640](https://github.com/codyai/codyai/issues/30640)
...
### How do I install CodyAI on Linux
...
### How do I install CodyAI on a VPS
...
### Can I ask CodyAI to update itself
...
```bash
codyai update
codyai update status
codyai update --channel stable|beta|dev
codyai update --tag <dist-tag|version>
codyai update --no-restart
```

If you must automate from an agent:

```bash
codyai update --yes --no-restart
codyai gateway restart
```
...
`codyai onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run CodyAI with **API keys** (Anthropic/OpenAI/others) or with
...
OpenAI Codex OAuth is explicitly supported for external tools like CodyAI.
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `codyai models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `codyai models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. CodyAI no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so CodyAI can keep replying while a provider is rate-limited.
...
CodyAI supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.4` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. CodyAI fully supports **OpenAI Code (Codex) subscription OAuth**.
OpenAI explicitly allows subscription OAuth usage in external tools/workflows
like CodyAI. The onboarding wizard can run the OAuth flow for you.

See [OAuth](/concepts/oauth), [Model providers](/concepts/model-providers), and [Wizard](/start/wizard).

### How do I set up Gemini CLI OAuth

Gemini CLI uses a **plugin auth flow**, not a client id or secret in `codyai.json`.

Steps:

1. Enable the plugin: `codyai plugins enable google-gemini-cli-auth`
2. Login: `codyai models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. CodyAI needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.5 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. CodyAI runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run CodyAI can I connect it to my MacBook Pro
...
- Use `codyai nodes status` / `codyai nodes list` to see it.
...
The onboarding wizard accepts `@username` input and resolves it to a numeric ID, but CodyAI authorization uses numeric IDs only.

Safer (no third-party bot):

- DM your bot, then run `codyai logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different CodyAI instances
...
If you run CodyAI via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the CodyAI code install. Your state
(`~/.codyai`) and workspace (`~/.codyai/workspace`) stay untouched.
...
**CodyAI-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run CodyAI on a dedicated machine
...
CodyAI is lightweight. For a basic Gateway + one chat channel:
...
### Can I run CodyAI in a VM and what are the requirements
...
### What is CodyAI in one paragraph

CodyAI is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

CodyAI is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for CodyAI
...
### Can CodyAI help with lead gen outreach ads and blogs for a SaaS
...
CodyAI draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

CodyAI is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use CodyAI when you
...
Showcase: [https://codyai.ai/showcase](https://codyai.ai/showcase)

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.codyai/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.codyai/codyai.json`). Precedence is `<workspace>/skills` > `~/.codyai/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.codyai/codyai.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.codyai/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which CodyAI treats as `<workspace>/skills`.
...
- Confirm cron is enabled (`cron.enabled`) and `CODYAI_SKIP_CRON` is not set.
...
```bash
codyai cron run <jobId> --force
codyai cron runs --id <jobId> --limit 50
```
...
### Can CodyAI run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.codyai.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-codyai-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. CodyAI can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.codyai/skills`) to allow Linux:

   ```markdown
   ---
   name: apple-notes
   description: Manage Apple Notes via the memo CLI on macOS.
   metadata: { "codyai": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured CodyAI workspace); CodyAI treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.codyai/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
- Persist `/home/node` with `CODYAI_HOME_VOLUME` so caches survive.
- Bake system deps into the image with `CODYAI_DOCKER_APT_PACKAGES`.
...
CodyAI memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

CodyAI also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, CodyAI auto-selects a provider when it
...
### Is all data used with CodyAI saved locally

No - **CodyAI's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.codyai` + your workspace directory).
...
### Where does CodyAI store its data

Everything lives under `$CODYAI_STATE_DIR` (default: `~/.codyai`):

| Path                                                            | Purpose                                                            |
| --------------------------------------------------------------- | ------------------------------------------------------------------ |
| `$CODYAI_STATE_DIR/codyai.json`                             | Main config (JSON5)                                                |
| `$CODYAI_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use)       |
| `$CODYAI_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth, API keys, and optional `keyRef`/`tokenRef`)  |
| `$CODYAI_STATE_DIR/secrets.json`                              | Optional file-backed secret payload for `file` SecretRef providers |
| `$CODYAI_STATE_DIR/agents/<agentId>/agent/auth.json`          | Legacy compatibility file (static `api_key` entries scrubbed)      |
| `$CODYAI_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)            |
| `$CODYAI_STATE_DIR/agents/`                                   | Per-agent state (agentDir + sessions)                              |
| `$CODYAI_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                           |
| `$CODYAI_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                       |

Legacy single-agent path: `~/.codyai/agent/*` (migrated by `codyai doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.codyai/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.codyai`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.codyai`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.codyai/skills`).

Default workspace is `~/.codyai/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.codyai/workspace" } },
}
```
...
Do **not** commit anything under `~/.codyai` (credentials, sessions, tokens, or encrypted secrets payloads).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall CodyAI
...
`workspace` to the repo root. The CodyAI repo is just source code; keep the
...
CodyAI reads an optional **JSON5** config from `$CODYAI_CONFIG_PATH` (default: `~/.codyai/codyai.json`):

```
$CODYAI_CONFIG_PATH
```

If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.codyai/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `CODYAI_GATEWAY_TOKEN`).
...
CodyAI enforces token auth by default, including loopback. If no token is configured, gateway startup auto-generates one and saves it to `gateway.auth.token`, so **local WS clients must authenticate**. This blocks other local processes from calling the Gateway.

If you **really** want open loopback, set `gateway.auth.mode: "none"` explicitly in your config. Doctor can generate a token for you any time: `codyai doctor --generate-gateway-token`.
...
- `default`: uses `All your chats, one CodyAI.` every time.
- `random`: rotating funny/seasonal taglines (default behavior).
- If you want no banner at all, set env `CODYAI_HIDE_BANNER=1`.

### How do I enable web search and web fetch

`web_fetch` works without an API key. `web_search` requires a Brave Search API
key. **Recommended:** run `codyai configure --section web` to store it in
...
- Daemons read env vars from `~/.codyai/.env` (or the service environment).
...
### Can the CodyAI browser run headless
...
5. Approve the node on the Gateway:
   ...
   ```bash
   codyai devices list
   codyai devices approve <requestId>
   ```
...
- Gateway is running: `codyai gateway status`
- Gateway health: `codyai status`
- Channel health: `codyai channels status`
...
### Can two CodyAI instances talk to each other local VPS
...
`codyai agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
codyai agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.codyai/codyai.json`).
- If you have no backup, re-run `codyai doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `codyai config set` for small changes.
- Use `codyai configure` for interactive edits.
...
```bash
codyai gateway --tailscale serve
```
...
### How does CodyAI load environment variables

CodyAI reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.codyai/.env` (aka `$CODYAI_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.codyai/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`CODYAI_LOAD_SHELL_ENV=1`, `CODYAI_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`codyai models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means CodyAI won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.codyai/.env`:
...
### Is there a way to make a team of CodyAI instances one CEO and many agents
...
### How do I completely reset CodyAI but keep it installed
...
```bash
codyai reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `CODYAI_PROFILE`), reset each state dir (defaults are `~/.codyai-<profile>`).
- Dev reset: `codyai gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), CodyAI skips the heartbeat run to save API calls.
...
No. CodyAI runs on **your own account**, so if you're in the group, CodyAI can see it.
...
```bash
codyai directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesn't CodyAI reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.codyai/agents/<agentId>/sessions/`.
...
- Use `codyai doctor` to spot stray workspaces and profile mismatches.
...
CodyAI's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, CodyAI currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `codyai models set ...` (updates just model config)
- `codyai configure --section model` (interactive)
- edit `agents.defaults.model` in `~/.codyai/codyai.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `codyai doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do CodyAI, Flawd, and Krill use for models

- These deployments can differ and may change over time; there is no fixed provider recommendation.
- Check the current runtime setting on each gateway with `codyai models status`.
...
Yes. CodyAI ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.codyai/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `codyai agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so CodyAI can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.codyai/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.codyai/agent/*` (migrated by `codyai doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.codyai/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `codyai models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `codyai models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `codyai models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.codyai/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:

    ```bash
    codyai models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), CodyAI will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: CodyAI now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
CodyAI uses provider-prefixed IDs like:
...
CodyAI may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `codyai models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
codyai models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
codyai models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
codyai models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
codyai models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key what's the difference

CodyAI supports both:
...
```
--port > CODYAI_GATEWAY_PORT > gateway.port > default 18789
```

### Why does codyai gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `codyai gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does codyai gateway status show Config cli and Config service different

You're editing one config file while the service is running another (often a `--profile` / `CODYAI_STATE_DIR` mismatch).

Fix:

```bash
codyai gateway install --force
```
...
CodyAI enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `codyai gateway --port <port>`.

### How do I run CodyAI in remote mode client connects to a Gateway elsewhere
...
- `codyai gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- Fastest: `codyai dashboard` (prints + copies the dashboard URL, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `codyai doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/`.
- Set `gateway.auth.token` (or `CODYAI_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token.
- Still stuck? Run `codyai status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `CODYAI_CONFIG_PATH` (per-instance config)
- `CODYAI_STATE_DIR` (per-instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `codyai --profile <name> …` per instance (auto-creates `~/.codyai-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `codyai --profile <name> gateway install`.

Profiles also suffix service names (`ai.codyai.<profile>`; legacy `com.codyai.*`, `codyai-gateway-<profile>.service`, `CodyAI Gateway (<profile>)`).
...
```
codyai tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/codyai/codyai-YYYY-MM-DD.log
```
...
- macOS: `$CODYAI_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.codyai/logs/...`; profiles use `~/.codyai-<profile>/logs/...`)
- Linux: `journalctl --user -u codyai-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "CodyAI Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `codyai gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart CodyAI
...
1. Is the Gateway running? `codyai gateway status`
2. Is the Gateway healthy? `codyai status`
3. Does the UI have the right token? `codyai dashboard`
...
```bash
codyai channels status
codyai channels logs --channel telegram
```
...
### ELI5 codyai gateway restart vs codyai gateway

- `codyai gateway restart`: restarts the **background service** (launchd/systemd).
- `codyai gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `codyai gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [CodyAI assistant setup](/start/codyai) and [Agent send](/tools/agent-send).

CLI sending:

```bash
codyai message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose CodyAI to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `codyai pairing approve --channel <channel> [--account <id>] <code>`
  - Pending requests are capped at **3 per channel**; check `codyai pairing list --channel <channel> [--account <id>]` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `codyai doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. CodyAI only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
codyai pairing approve whatsapp <code>
```

List pending requests:

```bash
codyai pairing list whatsapp
```
...
CodyAI blocks **cross-provider** messaging by default. If a tool call is bound
